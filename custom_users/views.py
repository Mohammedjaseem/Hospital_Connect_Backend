...
def register_user(request):
    ...
    try:
        ...
        with transaction.atomic():
            ...
            print("otp : ",otp)
            send_otp_to_email.delay(user.email, otp,name,org_instance.name)  # Send OTP to user's email using Celery
...
def resend_otp(request):
    ...
    try:
        ...
        otp_instance.save()
        send_otp_to_email.delay(user.email, otp,user.name,org_instance.name)  # Send new OTP to user's email using celery
